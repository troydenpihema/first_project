  ...
  play(name) {
    ...
    switch (name) {
      ...
      case 'hurt':
        ...
        break;
      case 'powerup':
        this.tone(440, 0.08, 'triangle', this.sfxGain, 0.22);
        setTimeout(() => this.tone(660, 0.08, 'triangle', this.sfxGain, 0.22), 70);
        setTimeout(() => this.tone(880, 0.12, 'triangle', this.sfxGain, 0.22), 140);
        break;
      case 'checkpoint':
