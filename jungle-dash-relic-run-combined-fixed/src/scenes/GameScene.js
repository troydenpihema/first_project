...
export default class GameScene extends Phaser.Scene {
  ...
  createMovingPlatform(x, y, w, h, minX, maxX, speed) {
    const platform = this.add.rectangle(x, y, w, h, this.theme.near);
  ...
  updateMovingPlatforms() {
    this.movingPlatforms.children.iterate(platform => {
      ...
      if (platform.x <= platform.minX) platform.body.setVelocityX(platform.speed);
      if (platform.x >= platform.maxX) platform.body.setVelocityX(-platform.speed);
    });
  }
